  ...
  return (
    <section id="topo" className="relative pt-36 md:pt-48 pb-20 md:pb-28 px-6 md:px-10 overflow-hidden">
      <div className="mx-auto max-w-6xl">
        <p className="mb-3 font-display text-2xl md:text-3xl text-wine">
        ...
        <div className="mt-12 flex flex-wrap items-center gap-x-8 gap-y-4">
          ...
          <a
            href="#atuacao"
            className="inline-block font-body text-sm uppercase tracking-[0.14em] text-ink/60 border-b border-brass/60 pb-1 hover:text-wine hover:border-wine hover:translate-x-0.5 transition duration-200"
          >
            Ver como ajudamos
          </a>
        </div>
